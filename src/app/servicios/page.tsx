...
const courses = [
  ...
  // ── Liderazgo ─────────────────────────────────────────────────────────────
  {
    ...
    description: 'Principios del aprendizaje efectivo\npara líderes y educadores',
  ...
  },
  {
    ...
    description: 'Estudio semanal para desarrollar\nuna verdadera relación con el Creador',
  ...
  },
  {
    ...
    description: 'Identifica causas del conflicto\ny aprende a resolverlo sanamente',
    imagePath: '/assets/apreton-de-manos-de-pareja-de-corazon@2x.png',
    modalIcon: '/assets/apreton-de-manos-de-pareja-de-corazon@2x.png',
    badge: null,
    longDescription:
  ...
  },
  {
    ...
    description: 'Taller para líderes que quieren\nliderar con visión y propósito',
    imagePath: '/assets/pasos-de-carrera@2x.png',
    modalIcon: '/assets/pasos-de-carrera@2x.png',
    badge: null,
    longDescription:
  ...
  },
  {
    ...
    description: 'Identifica y enfrenta los desafíos\ndel liderazgo con efectividad',
    imagePath: '/assets/balancearse@2x.png',
    modalIcon: '/assets/balancearse@2x.png',
    badge: null,
    longDescription:
  ...
  // ── Empresarios ───────────────────────────────────────────────────────────
  {
    ...
    description: 'Aplica principios de fe en tu\nvida profesional y empresarial',
    imagePath: '/assets/coworking@2x.png',
    modalIcon: '/assets/coworking@2x.png',
    badge: null,
    longDescription:
  ...
  },
  {
    ...
    description: 'Desarrolla tu potencial en compromisos,\nconvicciones y actitudes',
  ...
  },
  {
    ...
    modalIcon: '/assets/gente-tirando@2x.png',
    badge: null,
    longDescription:
  ...
  // ── Terapia ───────────────────────────────────────────────────────────────
  {
    ...
    imagePath: '/assets/pareja-de-lesbianas@2x.png',
    modalIcon: '/assets/pareja-de-lesbianas@2x.png',
    badge: null,
    longDescription:
  ...
  },
  {
    ...
    modalIcon: '/assets/anillos-boda (1)@2x.png',
    badge: null,
    longDescription:
  ...
  },
  {
    ...
    imagePath: '/assets/manos-sosteniendo (1)@2x.png',
    modalIcon: '/assets/manos-sosteniendo (1)@2x.png',
    badge: null,
    longDescription:
  ...
  // ── Mujeres ───────────────────────────────────────────────────────────────
  {
    ...
    imagePath: '/assets/aprendizaje-electronico (1)@2x.png',
    modalIcon: '/assets/aprendizaje-electronico (1)@2x.png',
    badge: null,
    longDescription:
  ...
  },
  {
    ...
    imagePath: '/assets/tiempo-de-fitness (1)@2x.png',
    modalIcon: '/assets/tiempo-de-fitness (1)@2x.png',
    badge: null,
    longDescription:
